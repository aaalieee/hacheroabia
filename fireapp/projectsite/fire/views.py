...
# fireapp/views.py
from .utils import get_data_from_psusphere, send_data_to_psusphere

def dashboard_view(request):
    data = get_data_from_psusphere()
...
def submit_data_view(request):
    if request.method == 'POST':
        ...
        response = send_data_to_psusphere(data)
        return render(request, 'submit_success.html', {'response': response})
